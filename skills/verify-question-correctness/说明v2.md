...
* Triage urgency only.
*
* Deliberately NOT named P0/P1/P2: in this repository P0/P1/P2 already
* means "confirmed defect severity" produced by the
* verify-question-correctness skill. Reusing it here would let
* `P0 candidate` be misread as "confirmed P0 defect".
  */
...
if (a.verificationPriority !== b.verificationPriority) {
  return a.verificationPriority.localeCompare(
    b.verificationPriority,
  );
}
...
"No severity rating, not a correctness verdict.",
