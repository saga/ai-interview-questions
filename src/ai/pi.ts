...
// 上层（variantGenerator / interviewAgent）才表达业务语义。浏览器：密钥经内存 CredentialStore 注入。

import { createModels } from '@earendil-works/pi-ai';
import type { CredentialStore, Model, ProviderId } from '@earendil-works/pi-ai';
...
/** 调用 LLM 并返回纯文本（一次性补全，用于变体生成等 one-shot 场景）。 */
